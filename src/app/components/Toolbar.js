    ...
    return (
      <Container className="toolbar-container">
        <div className="leftbar">
          <div
            title="Font Family"
            className="font-familiy-container fontFamily"
          >
            <div>
              <FontPicker
                ref={this.pickerRef}
          ...
          <div className="overlap-container">
            <div
              ...
              className="horizontalflip"
            >
              <i
                className="fas fa-ruler-vertical fa-rotate-270"
                aria-hidden="true"
              ></i>
            </div>
            <div
                ...
                <div className="effsection separator">
                  ...
                  <div className="control">
                    <input
                      type="checkbox"
                      id="switch"
                      onChange={this.outlineCheckBox}
                      checked={this.state.outlinechecked}
                    />
                  ...
                  <div className="effsection">
                    ...
                    <div className="font-color-container">
                      <div className="colrsec" onClick={this.strokepickerOpen}>
                        <div
                          ref={this.textstrokecolRef}
                          className="primcol"
                          style={{ background: this.state.backgroundcol }}
                        />
                        <img
                          className="arrowimg"
                          src={require("../images/down-arrow.png")}
                ...
                <div className="effsection separator">
                  ...
                  <div className="control">
                    <input
                      type="checkbox"
                      id="switch1"
                      onChange={this.glowCheckBox}
                      checked={this.state.glowchecked}
                    />
                  ...
                  <div className="effsection">
                    ...
                    <div className="font-color-container">
                      <div className="colrsec" onClick={this.glowpickerOpen}>
                        <div
                          ref={this.textglowcolRef}
                          className="primcol"
                          style={{ background: this.state.glowbackgroundcol }}
                        />
                        <img
                          className="arrowimg"
                          src={require("../images/down-arrow.png")}
        ...
        <div className="rightbar">
          ...
          <div title="Delete" className="btn-delete" onClick={this.deleteItem}>
            <span>
              <i className="far fa-trash-alt text-danger arrow"></i>
            </span>
          </div>
        </div>
      </Container>
