...
class LeftPanel extends Component {
  state = {
    ...
    client_id:
      "10c09efaf736d64b6c6f38d93620399aca995d73f0379c86995521375dff759d",
    pagenum: 1
  };
      ...
      <div className="side-panel-container">
        <TabPanel tabId="vertical-tab-one">
          <Container className="text-editer">
            <Row>
              <Col>
                <p className="first-title text-center text-primary">
                  Add some text to your artwork.
                </p>
              </Col>
            </Row>
            <Row>
              <Col>
                <h1 className="big-title" onClick={this.addHeadingtxt}>
                  Add Heading
                </h1>
              </Col>
            </Row>
            <Row>
              <Col>
                <h3 className="sub-title" onClick={this.addSubheadingtxt}>
                  Add Subheading
                </h3>
              </Col>
            </Row>
            <Row>
              <Col>
                <h5 className="text" onClick={this.addText}>
                  Add text
                </h5>
              </Col>
            </Row>
                  ...
                  {this.state.displaybgColorPicker ? (
                    <div className="popover">
                      ...
                      <SketchPicker
                        ...
                        onChangeComplete={this.setCanvasFill}
                      />
                    </div>
                  ) : null}
                </div>
              ...
              <Col>
                ...
                <div className="gradients-colors">
                  <span
                    ...
                    onClick={() =>
                      this.setGradientBGcolor("#62ff00", "yellow", "vertical")
                    }
                  />
                  <span
                    className="grdcol2 grdcolor"
                    onClick={() =>
                      this.setGradientBGcolor("red", "yellow", "horizontal")
                    }
                  />
                  <span
                  ...
                  >
                    <div className="gradcolorsection">
                      <div className="grdsection">
                        ...
                        {this.state.displaygrad1ColorPicker ? (
                          <div className="popover">
                            <div
                              className="cover"
                              onClick={this.grad1colorClose}
                            />
                            <SketchPicker
                              color={this.state.grad1color}
                              onChangeComplete={this.setGradient1BGcolor}
                            />
                          </div>
                        ) : null}
                        ...
                        {this.state.displaygrad2ColorPicker ? (
                          <div className="popover">
                            <div
                              className="cover"
                              onClick={this.grad2colorClose}
                            />
                            <SketchPicker
                              color={this.state.grad2color}
                              onChangeComplete={this.setGradient2BGcolor}
                            />
                          </div>
                        ) : null}
                      </div>
                      <div className="grdsection">
                        <div
                          className="swatch"
                          onClick={this.setVerticalgradient}
                        >
                          <div
                            className="grad-color verticalgradient"
                            title="Vertical"
                          />
                        </div>
                        <div
                          className="swatch"
                          onClick={this.setRadialgradient}
                        >
                          <div
                            className="grad-color radialgradient"
                            title="Radial"
                          />
                        </div>
                      </div>
            ...
            <Nav tabs>
                ...
                <NavItem>
                  <NavLink
                    className={classnames({
                      active: this.state.imgactiveTab === "1"
                    })}
              ...
              <Col sm="6">
                <NavItem>
                  <NavLink
                    className={classnames({
                      active: this.state.imgactiveTab === "2"
                    })}
                  ...
                  <Col sm="12">
                    <div className="pixabaysection">
                      <Form className="searchbar">
                        <Input
                          type="text"
                          onKeyPress={(event) => this.searchImage(event)}
                      ...
                      >
                        {this.state.apiImg.map((img, index) => (
                          <span
                            ...
                            key={index}
                            onClick={() => this.addImage(img.largeImageURL)}
                          >
                            <img
                              className="pixabay"
                  ...
                  <Col sm="12">
                    <div className="pixabaysection">
                      <Form className="searchbar">
                        <Input
                          type="text"
                          onKeyPress={(event) => this.searchUnsplashimg(event)}
                          placeholder="Search Images"
                        />
                      </Form>
                      <div
                        ...
                        {this.state.unsplashImg.map((photo, index) => {
                          return (
                            <span
                              className="image-wrapper"
                              key={index}
                              onClick={() => this.addImage(photo.urls.regular)}
                            >
                              <img
                                className="pixabay"
